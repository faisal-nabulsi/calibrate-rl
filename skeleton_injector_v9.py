...
DEPTH1_PARTNERS={'infinite_product_exp','unit_conversion_area','trapezoid_area','vieta_sumcubes','rate_closing','percent_compound','three_number_system','point_rotation','digit_count_bigprod','arith_series_sum','geo_first_exceed','mean_removal','distinct_product_count'}
...
def c_loglaws():
    base=random.choice([2,3,5]); e1=random.randint(4,9); e2=random.randint(4,9); e3=random.randint(1,5)  # v9: small powers, recognizable
    return (random.choice([
